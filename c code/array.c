...
// 5. Write a C program that inputs 8 floating numbers of an array and
// print the addition of them.
// 6. Write a C program to declare four arrays of same size, input
// values inside three arrays, do addition of three arrays and save it
// in fourth array and print the addition of arrays.